      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex-shrink-0 z-10">
            <img className="h-20 w-auto" src={logo} alt="Morent Logo" />
          </Link>

          {/* Search Bar (visible on scroll) - hidden on mobile/tablet */}
          <div className={`hidden lg:block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl px-4 transition-all duration-300 ${showSearch ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}`}>
          ...
          <div className="flex items-center gap-3 md:gap-4 z-10">
            ...
            <div className="relative">
              ...
              >
                ...
                {isLoggedIn ? (
                  <img
                    src={userProfile?.imageProfileURL || '/default-avatar.png'}
                    alt={userProfile ? `${userProfile.name} ${userProfile.surname}`.trim() || userProfile.username : 'User'}
                    ...
                    {isLoggedIn ? (
                      <>
                        ...
                        <Link
                          ...
                          className="block px-4 py-2.5 text-sm text-gray-900 hover:bg-gray-50 font-bold"
                        >
                          Become a host
                        </Link>
